...
};?>"><a href="<?php echo base_url()?>"><i class="icon icon-home"></i> <span>Painel Inicial</span></a></li>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="<?php echo base_url()?>" title="Dashboard" class="tip-bottom"><i class="icon-home"></i> Painel Inicial</a> <?php if ($this->uri->segment(1) != null) {
