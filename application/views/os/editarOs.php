                                ...
                                <form action="<?php echo current_url(); ?>" method="post" id="formOs">
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <h3>#Protocolo: <?php echo $result->idOs ?></h3>
                                            ...
                                            <input id="tecnico" class="span12" type="text" name="tecnico" value="<?php echo $result->nome ?>"   /><input id="usuarios_id" class="span12" type="hidden" name="usuarios_id" value="<?php echo $result->usuarios_id ?>"  />
                                            
                                    
                                            <label for="defeito">Técnico Ajudante</label>
                                            <input class="span12" name="defeito" type="text" id="defeito" value="<?php echo $result->defeito ?>"/>                                          <input id="defeitos" class="span12" type="hidden" name="defeitos" value="<?php echo $result->defeito ?>"  />
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        <div class="span3">
                                            ...
                                            <select class="span12" name="status" id="status" value="">
                                                ...
                                                <option <?php if ($result->status == 'Aguardando Agendamento') {  echo 'selected'; } ?> value="Aguardando Agendamento">Aguardando Agendamento</option>
                                                <option <?php if ($result->status == 'Aguardando Produção') {  echo 'selected'; } ?> value="Aguardando Produção">Aguardando Produção</option>
                                                <option <?php if ($result->status == 'Cobrança') {  echo 'selected'; } ?> value="Cobrança">Cobrança</option>
                                                <option <?php if ($result->status == 'Conserto') {  echo 'selected'; } ?> value="Conserto">Conserto</option>
                                                <option <?php if ($result->status == 'Conserto e Manutenção') {  echo 'selected'; } ?> value="Conserto e Manutenção">Conserto e Manutenção</option>
                                                <option <?php if ($result->status == 'Entrega') {  echo 'selected'; } ?> value="Entrega">Entrega</option>
                                                <option <?php if ($result->status == 'Faturado') { echo 'selected'; } ?> value="Faturado">Faturado</option>
                                                <option <?php if ($result->status == 'Feedback Cliente') {  echo 'selected'; } ?> value="Feedback Cliente">Feedback Cliente</option>
                                                <option <?php if ($result->status == 'Manutenção') {  echo 'selected'; } ?> value="Manutenção">Manutenção</option>
                                                <option <?php if ($result->status == 'Orçamento') {  echo 'selected'; } ?> value="Orçamento">Orçamento</option>
                                                <option <?php if ($result->status == 'Orçamento de Manutenção') {  echo 'selected'; } ?> value="Orçamento de Manutenção">Orçamento de Manutenção</option>
                                                <option <?php if ($result->status == 'Orçamento e Conserto') {  echo 'selected'; } ?> value="Orçamento e Conserto">Orçamento e Conserto</option>
                                                <option <?php if ($result->status == 'Orçamento e Manutenção') {  echo 'selected'; } ?> value="Orçamento e Manutenção">Orçamento e Manutenção</option>
                                                <option <?php if ($result->status == 'Orçamento e Trabalho') {  echo 'selected'; } ?> value="Orçamento e Trabalho">Orçamento e Trabalho</option>
                                                <option <?php if ($result->status == 'Panfletagem') {  echo 'selected'; } ?> value="Panfletagem">Panfletagem</option>
                                                <option <?php if ($result->status == 'Pendência') {  echo 'selected'; } ?> value="Pendência">Pendência</option>
                                                <option <?php if ($result->status == 'Retirada') {  echo 'selected'; } ?> value="Retirada">Retirada</option>
                                                <option <?php if ($result->status == 'Solicitação de Conserto') {  echo 'selected'; } ?> value="Solicitação de Conserto">Solicitação de Conserto</option>
                                                <option <?php if ($result->status == 'Solicitação de Manutenção') {  echo 'selected'; } ?> value="Solicitação de Manutenção">Solicitação de Manutenção</option>
                                                <option <?php if ($result->status == 'Solicitação de Orçamento') {  echo 'selected'; } ?> value="Solicitação de Orçamento">Solicitação de Orçamento</option>
                                                <option <?php if ($result->status == 'Solicitação de Visita Técnica') {  echo 'selected'; } ?> value="Solicitação de Visita Técnica">Solicitação de Visita Técnica</option>
                                                <option <?php if ($result->status == 'Tarefa Miami') {  echo 'selected'; } ?> value="Tarefa Miami">Tarefa Miami</option>
                                                <option <?php if ($result->status == 'Término de Trabalho') {  echo 'selected'; } ?> value="Término de Trabalho">Término de Trabalho</option>
                                                <option <?php if ($result->status == 'Trabalho') {  echo 'selected'; } ?> value="Trabalho">Trabalho</option>
                                                <option <?php if ($result->status == 'Trabalho e Conserto') {  echo 'selected'; } ?> value="Trabalho e Conserto">Trabalho e Conserto</option>
                                                <option <?php if ($result->status == 'Trabalho e Manutenção') {  echo 'selected'; } ?> value="Trabalho e Manutenção">Trabalho e Manutenção</option>
                                                <option <?php if ($result->status == 'Venda Direta') {  echo 'selected'; } ?> value="Venda Direta">Venda Direta</option>
                                                <option <?php if ($result->status == 'Visita Técnica') {  echo 'selected'; } ?> value="Visita Técnica">Visita Técnica</option>
                                            </select>
                                        </div>
...
<option <?php if ($result->garantia == 'Aberto') {  echo 'selected'; } ?> value="Aberto">Aberto</option>
                                                <option <?php if ($result->garantia == 'Fechado') {  echo 'selected'; } ?> value="Fechado">Fechado</option>
                                        ...
                                        <div class="span3">
                                            ...
                                            <input id="dataInicial" class="span8 datepicker" type="text" name="dataInicial" value="<?php echo date('d/m/Y', strtotime($result->dataInicial)); ?>"  />
                                        </div>
                                        
                                        
                                        <div class="span3">
                                            <label for="osdata">Horário</label>
                                            <input id="osdata" class="span8" type="text" name="osdata" value="<?php echo $result->osdata ?>"  />
                                        </div>
