...
<div class="span12" style="margin-top:0">
      ...
      <div class="">
         <div class="">
            ...
            <div class="control-group">
               ...
               <div class="controls"><input type="text" id="CPF" name="CPF" value="" /></div>
            </div>
         </div>
      </div>
   </div>
   <div class="span3">
      <div class="">
         <div class="">
            <div class="control-group">
               <label for="Interesses" class="control-label">Interesses</label>
               <div class="controls">
                  <label>
                  <input type="checkbox" class="Interesses" name="Interesses" value="R" />
                  Arte
                  </label>
                  <label>
                  <input type="checkbox" class="Interesses" name="Interesses" value="A" />
                  Antiguidade
                  </label>
                  <label>
                  <input type="checkbox" class="Interesses" name="Interesses" value="J" />
                  Judicial
                  </label>
               </div>
            </div>
            <div class="control-group">
               ...
               <div class="controls"><input type="text" rel="data" id="DataCadastro" name="DataCadastro" value="" /></div>
            </div>
         </div>
      </div>
   </div>
      ...
      <div class="">
         <div class="">
            <div class="control-group">
               <div class="controls">
                  <label>
                  <input type="checkbox" value="1" name="EhProprietario" id="EhProprietario" />
                  Proprietário  
                  </label>              
                  <label>
                  <input type="checkbox" value="1" name="EhCliente" id="EhCliente" />
                  Cliente
                  </label>
                  <label>
                  <input type="checkbox" value="1" name="EhPendente" id="EhPendente" />
                  Pendente
                  </label>
               </div>
            </div>
...
<!-- FIM -->
        ...
        <div class="span12" style="margin-left: 0">
            ...
            <div class="span3">
                ...
                placeholder="Pesquisar Cliente" class="span10" value="" >
            </div>

            <div class="span3">

                <input type="text" name="tecnico"  id="tecnico"  
                placeholder="Pesquisar Técnicos" class="span10" value="" >
            ...
            <div class="span3">
                ...
                placeholder="Pesquisar Cidade" class="span10" value="" >
            ...
            <div class="span3">
                ...
                placeholder="Pesquisar Bairro" class="span10" value="" >
