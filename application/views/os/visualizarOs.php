                                ...
                                <tr>
                                    <td style="width: 25%; padding-left: 0">
                                        <ul>
                                            <li>
                                                <span><h5>Cliente</h5>
                                                <span><?php echo $result->codigoCliente?></span> - <span><?php echo $result->nomeCliente?></span> - <?php echo $result->telefone?><br/> 
                                                <span><?php echo $result->rua?>, <?php echo $result->numero?>, <?php echo $result->bairro?></span>, <br>
                                                <span><?php echo $result->cidade?> - <?php echo $result->estado?></span><br><span>OBS: <?php echo $result->obs?></span><br>
                                    ...
                                    <td style="width: 25%; padding-left: 0">
                                        <ul>
                                            <li>
                                                <span><h5>Técnicos</h5></span>
                                                Responsável: <span><?php echo $result->nome?></span><br/>
                                                
                                                
                                                Ajudante: <span><?php echo $result->defeito?></span> <br/>
                                    ...
                                    <td style="width: 25%; padding-left: 0">
                                        <ul>
                                            <li>
                                                <span><h5>Demanda</h5></span> 
                                                <span>Serviço: <?php echo $result->descricaoProduto?></span><br/>
                                    ...
                                    <td style="width: 25%; padding-left: 0">
                                        <ul>
                                            <li>
                                                <span><h5>Detalhes do Serviço</h5></span> 
                                                <span>Status Interno: <?php echo $result->garantia?></span><br/>
                                                <span>Data: <?php echo $result->dataInicial?></span></br>
                                                <span>Horário: <?php echo $result->osdata?></span></br>
