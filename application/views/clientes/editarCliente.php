            ...
            <div class="widget-content nopadding">
                ...
                <form action="<?php echo current_url(); ?>" id="formCliente" method="post" class="form-horizontal" >
                    <div class="control-group">
                        ...
                        <label for="codigoCliente" class="control-label">Código<span class="required">*</span></label>
                        <div class="controls">
                            <input id="codigoCliente" type="text" name="codigoCliente" value="<?php echo $result->codigoCliente; ?>"  />
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="nomeCompleto" type="text" name="nomeCompleto" value="<?php echo $result->nomeCompleto; ?>"  />
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="data" class="control-label">Data Nascimento / Data Fundação<span class="required">*</span></label>
                        <div class="controls">
                            <input id="data" type="text" name="data" value="<?php echo $result->data; ?>"  />
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="rgie" type="text" name="rgie" value="<?php echo $result->rgie; ?>"  />
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group" class="control-label">
                        ...
                        <div class="controls">
                            <input id="obs" type="text" name="obs" value="<?php echo $result->obs; ?>"  />
                        </div>
                    </div>
                    <div class="control-group" class="control-label">
                        <label for="como" class="control-label">Como conheceu</label>
                        <div class="controls">
                            <input id="como" type="text" name="como" value="<?php echo $result->como; ?>"  />
                        </div>
                    </div>
