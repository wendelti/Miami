                                        ...
                                        <table class="table table-bordered">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><?php echo $result->codigoCliente ?></td>
                                                </tr>
                                                <tr>
                                                    <td style="text-align: right; width: 30%"><strong>Nome / Nome Fantasia</strong></td>
                                                    <td><?php echo $result->nomeCliente ?></td>
                                                </tr>
                                                <tr>
                                                    <td style="text-align: right; width: 30%"><strong>Nome Completo / Razão Social</strong></td>
                                                    <td><?php echo $result->nomeCompleto ?></td>
                                                </tr>
                                                <tr>
                                                    <td style="text-align: right; width: 30%"><strong>Data Nascimento / Data Fundação</strong></td>
                                                ...
                                                <tr>
                                                    <td style="text-align: right; width: 30%"><strong>RG/IE</strong></td>
                                                    <td><?php echo $result->rgie ?></td>
                                                </tr>
                                                
                                                <tr>
                                                    <td style="text-align: right; width: 30%"><strong>Informações</strong></td>
                                                    <td><?php echo $result->info ?></td>
                                                </tr>
                                              
                                                <tr>
                                                    <td style="text-align: right; width: 30%"><strong>Como conheceu</strong></td>
                                                    <td><?php echo $result->como ?></td>
                                                </tr>
