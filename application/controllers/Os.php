...
class Os extends CI_Controller
{
    ...
    function gerenciar()
    {
        ...
        $this->data['results'] = $this->os_model->getOs('os', 'idOs,dataInicial,dataFinal,garantia,osdata,descricaoProduto,defeito,status,observacoes,laudoTecnico', $where_array, $config['per_page'], $this->uri->segment(3));
    ...
    function editar()
    {
        ...
        if ($this->form_validation->run('os') == false) {
            ...
            $data = array(
                ...
                'osdata' => $this->input->post('osdata'),
                'descricaoProduto' => $this->input->post('descricaoProduto'),
                'defeito' => $this->input->post('defeito'),
                'status' => $this->input->post('status'),
                'hist' => $this->input->post('hist') . $this->input->post('status'),
    ...
    public function imprimir()
    {
        ...
        foreach($ids as $id){
            ...
            $pagina .= $this->load->view('os/imprimirOs', $this->data, TRUE);
